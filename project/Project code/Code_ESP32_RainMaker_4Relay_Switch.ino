...
const char *service_name = "PROV_1234567";
...
static uint8_t SwitchPin1 = 23;  //D13
static uint8_t SwitchPin2 = 22;  //D12
static uint8_t SwitchPin3 = 21;  //D14
static uint8_t SwitchPin4 = 19;  //D27
...
void setup()
{
    ...
    Node my_node;    
    my_node = RMaker.initNode("ESP32_Relay");
